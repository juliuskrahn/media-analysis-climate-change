...
class Graph:
    ...
    def plot(self, name, articles_about_climate_change_percent_array, values_array):
        self.ax.plot(articles_about_climate_change_percent_array, values_array, "o", label=name, alpha=0.5)

    def save(self):
        self.ax.set_xlabel("Artikel über Klimawandel pro Jahr")
        ...
        self.fig.savefig(f"result_platform_specific")
